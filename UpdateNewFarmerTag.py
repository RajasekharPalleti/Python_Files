...
def process_chunk(df_chunk, api_url, token, thread_id):
    ...
    for index, row in df_chunk.iterrows():
        ...
        if isinstance(raw_tags, str):
            farmer_tags = ast.literal_eval(raw_tags.strip())  # Result: [1, 2, 3]
        else:
            farmer_tags = raw_tags  # If already a list, just use it
        ...
        try:
            print(f"[Thread {thread_id}] Getting Farmer for: {farmer_id}")
            ...
            if "data" in farmer_data and isinstance(farmer_data["data"], dict):
                farmer_data["data"]["tags"] = farmer_tags
...
if __name__ == "__main__":
    tenant_code = "gpi"
    input_excel = "C:\\Users\\rajasekhar.palleti\\Downloads\\QAZONE5 farmer list.xlsx"
    output_excel = "C:\\Users\\rajasekhar.palleti\\Downloads\\3850_2025_06_16_updated.xlsx"
    api_url = "https://af-v2-gcp.cropin.co.in/qa5/services/farm/api/farmers"
